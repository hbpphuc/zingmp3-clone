...
const AlbumSongItem = ({ songData }) => {
    return (
        <div className="w-full h-[60px] p-[10px] flex justify-between items-center gap-[10px] rounded-[5px] hover:bg-[#ffffff1a] active:bg-[#ffffff26] border-b border-[#ffffff0d] cursor-pointer">
